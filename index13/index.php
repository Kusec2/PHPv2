	...
	if (!empty($_SESSION['news_title_1']) || !empty($_SESSION['news_title_2']) || !empty($_SESSION['news_title_3'])) {
		...
		<aside><h2 style="text-align:center">ZADNJE PREGLEDANO</h2>
			...
			if (isset($_SESSION['news_title_1'])) {
				print '<li style="border-bottom:2px dotted white;width:100%;"><a href="'. $_SESSION['news_link_1'].'" style="text-align:left;">'. $_COOKIE['news_title_1'].'</a></li>';
			}
			if (isset($_SESSION['news_title_2'])) {
				print '<li style="border-bottom:2px dotted white;width:100%;"><a href="'. $_SESSION['news_link_2'].'" style="text-align:left;">'. $_COOKIE['news_title_2'].'</a></li>';
			}
			if (isset($_SESSION['news_title_3'])) {
				print '<li style="border-bottom:2px dotted white;width:100%;"><a href="'. $_SESSION['news_link_3'].'" style="text-align:left;">'. $_COOKIE['news_title_3'].'</a></li>';
			}
			print '
			</ul>
